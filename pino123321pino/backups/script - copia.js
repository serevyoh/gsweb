...
const inicioX = posiciones[evento.id];

const finVisual = evento.fin && evento.fin !== evento.inicio
    ? posiciones[evento.id] + ancho
    : inicioX + ancho;
